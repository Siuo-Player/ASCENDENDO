...
A campanha sobe verticalmente. Os níveis usam plataformas estáticas e estado de jogo derivado para spawn e objetivo final. A dificuldade deve nascer sobretudo da geometria, leitura espacial, posicionamento e compromisso do salto, não de controlos cada vez mais complexos.
...
O editor faz parte do produto. Permite criar e alterar plataformas, navegar por níveis verticais, seleccionar e editar geometria, desfazer/refazer, guardar com validação e trabalhar sem depender de ferramentas externas. Spawn e objetivo final são estado derivado e não são authored nos ficheiros `.lvl`. O editor de campanha organiza os níveis da campanha.
