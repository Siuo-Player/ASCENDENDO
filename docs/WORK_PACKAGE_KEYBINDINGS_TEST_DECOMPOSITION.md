...
O baseline atual antes da decomposição é 167 casos e 901 assertions. A decomposição deve preservar a cobertura funcional; alterações nas contagens só são aceitáveis quando explicadas por correção explícita de testes, não pelo rearranjo.
