...
`docs/9-6-gate-status-studies-sync-2026-08-27`
...
The reconciliation must match current `main`, merged PR #82, and the active Windows evidence work.

## Decisões arquiteturais

No architectural change. This package changes only evidence/status vocabulary and records current Gate state.
...
- [x] Windows evidence scope reviewed.
...
Documentation-only. This package does not advance the implementation roadmap by itself.
