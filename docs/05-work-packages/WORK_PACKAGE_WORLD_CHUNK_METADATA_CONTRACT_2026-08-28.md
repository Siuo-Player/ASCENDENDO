...
**Branch:** `docs/9-6-world-chunk-contract-20260828-v2`
...
- [x] teste executável de characterization preparado na tranche seguinte;
...
**Residual:** decisão sobre metadata explícita permanece dependente de requisito; não é uma correção de produção nesta fase.