...
bool Pipeline::init(VulkanContext* ctx, Swapchain* swapchain, RenderPass* renderPass) {
    ...
    // Vertex Input Vazio! O próprio Vertex Shader gera a geometria
    ...
    // Viewport e Scissor assinalados como dinâmicos (para a Fase 5.2 gerir)
    ...
    colorBlendAttachment.blendEnable = VK_TRUE; // Transparência ativada!
