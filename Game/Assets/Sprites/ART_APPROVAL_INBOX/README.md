...
Um ID só é accionável como candidato visual quando existe um ficheiro/preview concreto que possa ser inspeccionado. Referências bibliográficas, nomes de pacotes ou linhas de registry, por si só, não contam como arte apresentada para aprovação.
