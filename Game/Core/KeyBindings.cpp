...
std::unordered_map<GameAction, std::vector<int>> KeyBindings::defaultBindings() {
    return {
        ...
        { GameAction::EditorCursorLeft,     { Key::LEFT } },
        { GameAction::EditorCursorRight,    { Key::RIGHT } },
        { GameAction::EditorCursorUp,       { Key::UP } },
        { GameAction::EditorCursorDown,     { Key::DOWN } },
        { GameAction::EditorToggleMode,     { Key::G } },
        { GameAction::EditorSizeDown,       { Key::LBRACKET } },
        { GameAction::EditorSizeUp,         { Key::RBRACKET } },
        { GameAction::EditorPlace,          { Key::ENTER } },
        { GameAction::EditorUndo,           { Key::Z } },
        { GameAction::EditorRedo,           { Key::Y } },
        { GameAction::EditorSelectPlatform, { Key::P } },
        { GameAction::EditorSelectSpawn,    { Key::T } },
        { GameAction::EditorSelectFlag,     { Key::F } },
...
constexpr KeyName KEY_NAMES[] = {
    ...
    { Key::P, "P" }, { Key::F, "F" }, { Key::T, "T" }, { Key::Z, "Z" }, { Key::Y, "Y" },
